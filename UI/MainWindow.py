...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1032, 765)
        self.lexicalanalys = QtWidgets.QTabWidget(Form)
        self.lexicalanalys.setGeometry(QtCore.QRect(0, 0, 1311, 761))
        font = QtGui.QFont()
        ...
        self.splitter_3.setGeometry(QtCore.QRect(434, 20, 561, 501))
        ...
        self.semantic_lb_3addr = QtWidgets.QPushButton(self.splitter_2)
        self.semantic_lb_3addr.setObjectName("semantic_lb_3addr")
        ...
        self.semantic_table_out = QtWidgets.QTableWidget(self.splitter_3)
        font = QtGui.QFont()
        ...
        self.splitter.setGeometry(QtCore.QRect(10, 20, 421, 501))
    ...
    def retranslateUi(self, Form):
        ...
        self.semantic_lb_3addr.setText(_translate("Form", "仅查看三地址指令"))
